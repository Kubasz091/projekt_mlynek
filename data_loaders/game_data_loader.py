...
from data_loaders.texture_registry import change_graphics_path, load_textures
...
def load_game_objects(board_size: int):
    ...
    try:
        ...
        if graphics_used is not None:
            change_graphics_path(graphics_used)
        load_textures()
        ...
        register_game_object(cursorP1)
        register_game_object(cursorP2)
